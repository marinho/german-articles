sap.ui.define([
    ...
    return Controller.extend("sap.ui.germanArticles.controller.App", {
        ...
        onNewGame: function () {
            var self = this;
            var component = self.getOwnerComponent();

            var allNouns = component.getModel('allNouns').oData.Nouns;

            var nouns = [];
            var indexes = [];
            var pendingNouns = [];
            while (indexes.length < component._nounsPerGame) {
        ...
        showNoun: function (nounIndex) {
            ...
            var articles = component._articles[styleBits[0]][styleBits[1]];
            var articleLabels = [];
